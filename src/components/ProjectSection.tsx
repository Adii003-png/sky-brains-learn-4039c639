                    ...
                    <BarChart data={modelComparison}>
                      ...
                      <Bar dataKey="r2" name="R² Score" radius={[6, 6, 0, 0]}>
                        {modelComparison.map((entry) => (
                          <motion.rect key={entry.model} fill={entry.color} />
                        ))}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={rulPredictions}>
                      ...
                      <Area type="monotone" dataKey="predicted" stroke="hsl(260, 70%, 60%)" fill="hsl(260, 70%, 60%)" fillOpacity={0.2} name="Predicted RUL" />
                    </AreaChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
